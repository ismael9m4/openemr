                    ...
                    <td width='640px'>
                        ...
                        <table class='text'>
                            ...
                            <tr>
                                ...
                                <td style="display: none" class='col-form-label'><?php echo xlt('Ethnicity'); ?>:</td>
                                <td style="display: none" colspan="2"><?php echo generate_select_list('ethnicity', 'ethnicity', $sql_ethnicity, 'Select Ethnicity', 'Unassigned', '', ''); ?></td>
                            </tr>
        ...
        if (!empty($_POST['form_refresh'])) {
            ...
            switch ($srch_option) {
                ...
                case "Insurance Companies":
                    ...
                    break;
                case "Demographics":
                    $sort = array("patient_date","patient_name","patient_id","patient_age","patient_sex","users_provider");
                    break;
            }
                ...
                <div id="report_results">
                    ...
                    if ($srch_option == "Medications" || $srch_option == "Allergies" || $srch_option == "Problems") { ?>
                        ...
                        <tr style="font-size:15px;">
                            ...
                            <td width="5%"><strong><?php echo xlt('Age');?></strong><?php echo $sortlink[3]; ?></td>
                            <td width="10%"><strong><?php echo xlt('Gender'); ?></strong><?php echo $sortlink[4]; ?></td>
                            <td colspan=5><strong><?php echo xlt('Provider');?></strong><?php echo $sortlink[5]; ?></td>
                        </tr>
                            <?php foreach ($patFinalDataArr as $patKey => $patDetailVal) { ?>
                                <tr bgcolor = "#CCCCCC" style="font-size:15px;">
                                    <td ><?php echo ($patDetailVal['patient_date'] != '') ? text(oeFormatDateTime($patDetailVal['patient_date'], "global", true)) : ""; ?></td>

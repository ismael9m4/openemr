            ...
            <tr>
                ...
                <td>
                    <div class="checkbox">
                        ...
                        <?php echo xlt('Mostrar día de la semana'); ?>
                        </label>
                    </div>
                </td>
                ...
                <td>
                    <div class="checkbox">
                        <label><input type="checkbox" name="with_canceled_appt" id="with_canceled_appt" <?php echo ($chk_with_canceled_appt) ? "checked" : ""; ?>>&nbsp;<?php echo xlt('Con citas canceladas'); ?>
                        </label>
                    </div>
                </td>
            </tr>

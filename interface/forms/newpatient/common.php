                ...
                <div id="visit-details" class="px-3">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-sm  <?php displayOption('enc_enable_class');?>">
                            <div class="form-group" <?php echo ($_SESSION['authUserID'] != 37) ? 'style="display:none;"' : ''; ?>>
                    ...
                    <div class="form-row align-items-center" <?php echo ($_SESSION['authUserID'] != 37) ? 'style="display:none;"' : ''; ?>>
                        <div class="col-sm">
                            <div class="form-group">
                    ...
                    <div class="form-row align-items-center"  <?php echo ($_SESSION['authUserID'] != 37) ? 'style="display:none;"' : ''; ?>>
                        ...
                        <div class="col-sm <?php echo $collectionDisplay; ?>">
                            <div class="form-group">
                                <label for='in_collection' class="text-right"><?php echo xlt('En Recuperación'); ?>:</label>

...
class C_FormVitals
{
    ...
    public function default_action_process()
    {
        ...
        if ($_POST["BMI"] > 42) {
            $_POST["BMI_status"] = 'Obesidad III';
        } elseif ($_POST["BMI"] > 34) {
            $_POST["BMI_status"] = 'Obesidad II';
        } elseif ($_POST["BMI"] > 30) {
            $_POST["BMI_status"] = 'Obesidad I';
        } elseif ($_POST["BMI"] > 27) {
            $_POST["BMI_status"] = 'Sobrepeso';
        } elseif ($_POST["BMI"] > 25) {
            $_POST["BMI_status"] = 'Normal Linea Base';
        } elseif ($_POST["BMI"] > 18.5) {
            $_POST["BMI_status"] = 'Normal';
        } elseif ($_POST["BMI"] > 10) {
            $_POST["BMI_status"] = 'Bajo peso';
        }

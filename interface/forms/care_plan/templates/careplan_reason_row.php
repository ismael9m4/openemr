    ...
    <div class="card mt-2 mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <!-- Nuevo campo Cara -->
                <div class="col-md-6 form-group">
                    <label><?php echo xlt("Cara"); ?></label>
                    <select name="cara[]" class="form-control">
                        <option value="O" <?php if (($obj['cara'] ?? "") == "O") echo "selected"; ?>><?php echo xlt("O"); ?></option>
                        <option value="M" <?php if (($obj['cara'] ?? "") == "M") echo "selected"; ?>><?php echo xlt("M"); ?></option>
                        <option value="D" <?php if (($obj['cara'] ?? "") == "D") echo "selected"; ?>><?php echo xlt("D"); ?></option>
                        <option value="V" <?php if (($obj['cara'] ?? "") == "V") echo "selected"; ?>><?php echo xlt("V"); ?></option>
                        <option value="L" <?php if (($obj['cara'] ?? "") == "L") echo "selected"; ?>><?php echo xlt("L"); ?></option>
                    </select>
                </div>
                <!-- Nuevo campo Diente o pieza -->
                <div class="col-md-6 form-group">
                    <label><?php echo xlt("Diente o pieza"); ?></label>
                    <input class="form-control" name="diente[]" type="text" value="<?php echo attr($obj['diente'] ?? ""); ?>" placeholder="<?php echo xlt("Ingrese número"); ?>" />
                </div>
            </div>
        </div>
    </div>

 ...
 */
 ...
 function care_plan_report($pid, $encounter, $cols, $id): void
 {
     ...
     // Modificación en la consulta para incluir cara y diente
     ...
     if ($data) { ?>
         <table class="table w-100">
             ...
             <tr>
                 ...
                 <th class="border p-1"><?php echo xlt('Cara'); ?></th>  <!-- Nueva columna para cara -->
                 <th class="border p-1"><?php echo xlt('Diente'); ?></th> <!-- Nueva columna para diente -->
             </tr>
             </thead>
             <tbody>
             <?php
             foreach ($data as $key => $value) { ?>
                 <tr>
                     ...
                     <td class="border p-1"><span class='text'><?php echo text($value['cara']); ?></span></td>  <!-- Mostrar valor de cara -->
                     <td class="border p-1"><span class='text'><?php echo text($value['diente']); ?></span></td> <!-- Mostrar valor de diente -->
                 </tr>
             <?php } ?>
             </tbody>
         </table>

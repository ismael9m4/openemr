 ...
 */
 ...
 // Nuevas variables para cara y diente
 $cara = $_POST['cara'];
 $diente = $_POST['diente'];
 ...
 if (!empty($count)) {
     foreach ($count as $key => $codeval) :
         ...
         // Obtener los valores de cara y diente
         $cara_val = $cara[$key] ?? '';
         $diente_val = $diente[$key] ?? '';
         ...
         sqlStatement(
             ...
             [
                 ...
                 $reason_low,
                 $reason_high,
                 $cara_val,  // Valor de cara
                 $diente_val  // Valor de diente
             ]
         );
     endforeach;
 }

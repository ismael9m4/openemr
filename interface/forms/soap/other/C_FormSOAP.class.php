...
class C_FormSOAP extends Controller
{
    ...
    function default_action_process()
    {
        ...
        // Procesar los campos diagnostico, laboratorio y fecha consulta
        $this->form->set_diagnostico($_POST['diagnostico'] ?? '');
        $this->form->set_laboratorio($_POST['laboratorio'] ?? '');
        $this->form->set_fecha_consulta($_POST['fecha_consulta'] ?? ''); // Procesar fecha consulta

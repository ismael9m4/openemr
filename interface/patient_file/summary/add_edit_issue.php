                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="form-group col" id='row_titles'>
                                <label for="form_titles" class=""><?php echo xlt('Seleccione o escriba el suyo en Título'); ?></label>
                        ...
                        <div class="row">
                            <div class="col d-flex justify-content-end">
                                <button type="button" class="btn btn-text mr-3" data-toggle="collapse" data-target="#expanded_options" aria-expanded="false" aria-controls="expanded_options"><?php echo xlt("Mostrar más campos"); ?>&nbsp;<i class="fa fa-angles-down"></i></button>
